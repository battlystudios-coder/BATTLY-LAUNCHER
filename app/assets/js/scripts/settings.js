    ...
    if (arguments_[0] === MSFT_REPLY_TYPE.ERROR) {
        ...
        switchView(getCurrentView(), viewOnClose, 500, 500, () => {
            ...
            if(arguments_[1] === MSFT_ERROR.NOT_FINISHED) {
                // User cancelled.
                msftLoginLogger.info('Accesso annullato dall\'utente.')
                return
            }
        ...
        if (Object.prototype.hasOwnProperty.call(queryMap, 'error')) {
            switchView(getCurrentView(), viewOnClose, 500, 500, () => {
                ...
                console.log('Errore durante l\'ottenimento dell\'authCode. L\'applicazione Azure è registrata correttamente?')
                console.log(error)
                console.log(errorDesc)
                console.log('Mappa completa delle query: ', queryMap)
                setOverlayContent(
                    error,
                    errorDesc,
                    Lang.queryJS('settings.msftLogin.okButton')
            ...
            msftLoginLogger.info('Acquisito authCode, procedo con l\'autenticazione.')
            ...
            AuthManager.addMicrosoftAccount(authCode).then(value => {
                ...
                .catch((displayableError) => {
                    ...
                    if(isDisplayableError(displayableError)) {
                        ...
                        // Uh oh.
                        msftLoginLogger.error('Errore non gestito durante l\'accesso.', displayableError)
    ...
    if (arguments_[0] === MSFT_REPLY_TYPE.ERROR) {
        switchView(getCurrentView(), VIEWS.settings, 500, 500, () => {
            ...
            if(arguments_.length > 1 && arguments_[1] === MSFT_ERROR.NOT_FINISHED) {
                // User cancelled.
                msftLogoutLogger.info('Disconnessione annullata dall\'utente.')
                return
            }
        ...
        msftLogoutLogger.info('Disconnessione avvenuta con successo. uuid:', uuid)
...
function populateReleaseNotes(){
    $.ajax({
        url: 'https://github.com/battlystudios-coder/BATTLY-LAUNCHER/releases.atom',
        success: (data) => {
