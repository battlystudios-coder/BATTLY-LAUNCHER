        ...
        if (!accounts.length) {
            ...
            for (let account of accounts) {
                ...
                if (account.meta.type === 'Xbox') {
                    console.log(`🔄 Accedere a un account Xbox con il tuo nome utente ${account.name}...`);
                    ...
                    console.log(`🔄 Aprire un account Mojang con il tuo nome utente ${account.name}...`);
                    let refresh_accounts;
                    ...
                    console.log(`🔄 Creazione di un account Battly con il tuo nome utente ${account.name}...`);
                    addAccount(account);
                    if (account.uuid === selectaccount) accountSelect(account.uuid)
                }
            }
